...
Item {
    ...
    readonly property string colorsPath: Quickshell.env("HOME") + "/.local/state/Archer/qs-colors.toml"
    readonly property string currentBackgroundPath: Quickshell.env("HOME") + "/.local/state/Archer/current-wallpaper"
    ...
    readonly property string idleStatePath: Quickshell.env("HOME") + "/.local/state/Archer/indicators/stay-awake"
    ...
    readonly property string notificationsStatePath: Quickshell.env("HOME") + "/.local/state/Archer/notifications.json"
    ...
    readonly property string launchWifiCmd: "uwsm app -- ~/Archer/bin/launch-wifi"
    readonly property string launchBtCmd:   "uwsm app -- ~/Archer/bin/launch-bluetooth"
